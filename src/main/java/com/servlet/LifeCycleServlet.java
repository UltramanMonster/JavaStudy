...
public class LifeCycleServlet extends HttpServlet {
    ...
    private static double startPoint = 0;//个税起征点，从配置文件中读取
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        System.out.println("执行 doPost() 方法 ...");
        ...
        try {
            double income = new Double(request.getParameter("income"));//工资数目
            double charge = income - startPoint;//应纳税部分
            double tax = 0;//缴税
            if (charge <= 0) {tax = 0;}//计算所得税
            ...
            out.println("<div class='leftDiv'>您的工资为</div><div class='rightDiv'>" + income + "</div>");
            out.println("</div>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<div style='line'>");
        out.println("<div class='leftDiv'>您的工资为</div><div align='left' class='rightDiv'>" +
                "<input type='text' name='income'>单位：元</div>");
        out.println("</div></br>");

        out.println("<div style='line'>");
        out.println("<div class='leftDiv'></div><div align='left' class='rightDiv'>" +
                "<input type='submit' value='计算个税' class='button'></div>");
        out.println("</div><br/>");
        out.println("</div>");
        out.println("</form>");
